...
typedef NS_ENUM(NSUInteger, WPAnalyticsStat) {
    ...
    WPAnalyticsStatGutenbergWarningConfirmDialogShownYesTapped,
    WPAnalyticsStatGutenbergWarningConfirmDialogShownCancelTapped,
    WPAnalyticsStatGutenbergWarningConfirmDialogShownDontShowAgainChecked,
    WPAnalyticsStatGutenbergWarningConfirmDialogShownDontShowAgainUnchecked,
    WPAnalyticsStatGutenbergWarningConfirmDialogShownLearnMoreTapped,
