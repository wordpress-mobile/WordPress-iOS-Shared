...
typedef NS_ENUM(NSUInteger, WPAnalyticsStat) {
    ...
    WPAnalyticsStatSupportOpenedHelpCenter,
    WPAnalyticsStatSupportOpenedNewRequest,
    WPAnalyticsStatSupportOpenedTicketList,
    WPAnalyticsStatSupportUserAttachedFile,
    WPAnalyticsStatSupportUserFileAttachmentFailed,
    WPAnalyticsStatSupportUserDeletedAttachment,
    WPAnalyticsStatSupportUserDeleteAttachmentFailed,
    WPAnalyticsStatSupportUserRepliedToTicket,
    WPAnalyticsStatSupportUserReplyFailed,
    WPAnalyticsStatSupportUserTicketListFailed,
    WPAnalyticsStatSupportUserViewedTicket,
    WPAnalyticsStatSupportUserViewTicketFailed,
    WPAnalyticsStatSupportUserSearchedHelpCenter,
